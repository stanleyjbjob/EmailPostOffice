...
{
    public class MailQueuesDataSeedContributor : IDataSeedContributor, ISingletonDependency
    {
        private bool IsSeeded = false;
        private readonly IMailQueueRepository _mailQueueRepository;
        private readonly IUnitOfWorkManager _unitOfWorkManager;

        public MailQueuesDataSeedContributor(IMailQueueRepository mailQueueRepository, IUnitOfWorkManager unitOfWorkManager)
        {
        ...
        public async Task SeedAsync(DataSeedContext context)
        {
            ...
            await _mailQueueRepository.InsertAsync(new MailQueue
            (
                id: Guid.Parse("fa57bb60-3af5-42e7-8926-2e4b6257cff6"),
                ...
                success: true,
                suspend: true,
                freezeTime: new DateTime(2001, 10, 27)
            ));

            await _mailQueueRepository.InsertAsync(new MailQueue
            (
                id: Guid.Parse("103bb4b0-94a9-4b45-9bc6-111e74420fef"),
                ...
                success: true,
                suspend: true,
                freezeTime: new DateTime(2014, 8, 15)
            ));
